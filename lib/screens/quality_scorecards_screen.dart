                        ...
                        child: PopupMenuButton<String>(
                          ...
                          itemBuilder: (context) => _providers.map((provider) {
                            return PopupMenuItem<String>(
                              ...
                              child: SizedBox(
                                width:
                                    180, // 👈 también controlas el ancho en la lista
                                child: Text(
                                  provider,
                                  overflow:
                                      TextOverflow.ellipsis, // 👈 mismo efecto
                                  maxLines: 1,
                                  style: TextStyle(
                                    fontSize: 14,
                        ...
                        Container(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: DataTable(
                              ...
                              rows: [
                                _buildDataRow('COA-PA', ['123', '456', '789'],
                                    ['50%', '75%', '90%'], ['10', '20', '30']),
                                _buildDataRow('CCS', ['234', '567', '890'],
                                    ['55%', '80%', '95%'], ['15', '25', '35']),
                                _buildDataRow('CAW', ['345', '678', '901'],
                                    ['60%', '85%', '92%'], ['12', '22', '32']),
                                _buildDataRow('CBP', ['456', '789', '012'],
                                    ['65%', '90%', '98%'], ['18', '28', '38']),
                                _buildDataRow('CBC', ['567', '890', '123'],
                                    ['70%', '95%', '99%'], ['25', '35', '45']),
                              ],
                            ),
                          ),
